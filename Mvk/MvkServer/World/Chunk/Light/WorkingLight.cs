...
//            }
//            Chunk.Light.countBlock = mapLight.Values.Count;
...
//            ChunkStorage storage = chunk.StorageArrays[sy];

//            if (chunk == null || sy < 0 || sy > ChunkBase.COUNT_HEIGHT15 || !storage.sky)
//                return (byte)type;

//            if (type == EnumSkyBlock.Sky)
//                return storage.lightSky[(pos.Y & 15) << 8 | (pos.Z & 15) << 4 | (pos.X & 15)];
//            return storage.lightBlock[(pos.Y & 15) << 8 | (pos.Z & 15) << 4 | (pos.X & 15)];
...
//        /// <param name="pos">позиция блока</param>
//        /// <param name="lightValue">яркость 0-15</param>
//        public void SetLight0(BlockPos pos, EnumSkyBlock type, byte lightValue)
//        {
...
//                if (type == EnumSkyBlock.Sky)
//                {
//                    chunk.StorageArrays[yc].lightSky[(pos.Y & 15) << 8 | (pos.Z & 15) << 4 | (pos.X & 15)] = lightValue;
//                }
//                else
//                {
//                    chunk.StorageArrays[yc].lightBlock[(pos.Y & 15) << 8 | (pos.Z & 15) << 4 | (pos.X & 15)] = lightValue;
//                }
