...
//        private readonly int vertexSize = 0;
...
//            bufferData.ConvertFloat(vertices);

//            BufferData(bufferData);
//        }

//        private void BufferData(BufferData bufferData)
//        {
//           //ByteBuffer
...
//                    if (attrs[i] == 0) break;
//                    int size = attrs[i];
//                    gl.VertexAttribPointer(i + xxx, size, OpenGL.GL_FLOAT, false, stride, new IntPtr(offset * sizeof(float)));
//                    gl.EnableVertexAttribArray(i);
//                    offset += size;
//                } else
//                {
//                    ddd(i, 1, stride, offset); offset++;
//                    ddd(i + 1, 1, stride, offset); offset++;
//                    ddd(i + 2, 1, stride, offset); offset++;
//                    xxx = 2;
//                }
//            }
...
//        private void ddd(uint i, int size, int stride, int offset)
//        {
